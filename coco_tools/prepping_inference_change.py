...
input_map = {
    "inference_metrics_yolo_416_Anova.csv": "output_yolo_416_Anova.json",
    "inference_metrics_yolo_416_co_occurance.csv": "output_yolo_416_co_occurance.json",
    "inference_metrics_yolo_416_disAnova.csv": "output_yolo_416_disAnova.json",
    "inference_metrics_yolo_416_semantic.csv": "output_yolo_416_semantic.json"
}

# use key to read the inference file and value to write the output file.
for key, value in input_map.items():
    inference_df = pd.read_csv(key)
