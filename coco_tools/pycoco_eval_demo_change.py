...
list_inputs = ["output_yolo_416_Anova.json", "output_yolo_416_co_occurance.json", "output_yolo_416_disAnova.json",
               "output_yolo_416_semantic.json"]

for input in list_inputs:
    cocoDt = cocoGt.loadRes(input)
